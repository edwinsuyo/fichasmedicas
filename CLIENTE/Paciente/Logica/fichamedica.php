...
$pdf->setAuthor('CAJA DE SALUD CORDES');
$pdf->setTitle('FICHA MEDICA');
$pdf->setSubject('REGIONAL SANTA CRUZ');
$pdf->setKeywords('TCPDF, PDF, FICHA, test, guide');

$PDF_HEADER_TITLE = "FICHA MEDICA CORDES";
$PDF_HEADER_STRING = "";
...
$txthoraficha =$_GET['txthoraficha'];;
$html ='
...
<table class="first" cellpadding="4" cellspacing="6">
 <tr>
  <td width="140" align="right"><b>No. DE ORDEN : </b></td>
  <td width="200" class"second"><b>'.$txtorden.'</b></td>
 </tr>
 <tr>
 <td width="140" align="right">PARENTESCO :</td>
 <td width="200"  class="second">'.$txtparentesco.'</td>
</tr>
 <tr>
  <td width="140" align="right">PACIENTE : </td>
  <td width="200"  class="second">'.$txtpaciente.'</td>
 </tr>
 <tr>
  <td width="140" align="right">EMPRESA : </td>
  <td width="200"  class="second">'.$txtempresa.'</td>
 </tr>
 <tr>
  <td width="140" align="right">MEDICO : </td>
  <td width="200"  class="second">'.$txtmedico.'</td>
 </tr>
 <tr>
  <td width="140" align="right">ESPECIALIDAD : </td>
  <td width="200"  class="second">'.$txtespecialidad.'</td>
 </tr>
 <tr>
  <td width="140" align="right">DIA : </td>
  <td width="200"  class="second">'.$txtdia.'</td>
 </tr>
 <tr>
 <td width="140" align="right">TURNO : </td>
 <td width="200"  class="second">'.$txtturno.'</td>
 </tr>
 <tr>
 <td width="140" align="right">HORA DE RESERVA : </td>
 <td width="200"  class="second">'.$txthoraficha.'</td>
 </tr>
</table>';
